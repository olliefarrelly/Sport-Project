# ============================================================
# DEFENSIVE MIDFIELDER (CDM) RATING MODEL
# ============================================================
# Goal: produce a single 0-100 "mid_rating" for every Defensive
# Midfielder, judged mostly on defensive work with some credit for
...
# Every raw per-90 stat is pulled ("shrunk") toward the CDM
...
# compared only against other CDMs.
#
...
#   Defensive 50% | Creativity 20% | Goal threat 15% | Market value 15%
#
...
# for elite players). This is fine for comparing CDMs to other
# CDMs, but NOT fine for comparing a CDM's rating directly to a
