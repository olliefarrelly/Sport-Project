# ============================================================
# CENTRAL MIDFIELDER (CM) RATING MODEL
# ============================================================
# Goal: produce a single 0-100 "mid_rating" for every Central
# ("box-to-box"/all-round) Midfielder, judged fairly evenly across
# defensive work, creativity, and goal threat.
#
...
# Every raw per-90 stat is pulled ("shrunk") toward the CM
...
# compared only against other CMs.
#
...
#   Defensive 28% | Creativity 30% | Goal threat 27% | Market value 15%
#
...
# for elite players). This is fine for comparing CMs to other CMs,
# but NOT fine for comparing a CM's rating directly to a forward's
# rating for team-strength purposes. A final rescale step
# (percent_rank on the finished rating, within each position group)
# should be applied across all position models before they feed
# into team simulation — see rescaling step (separate script).
# ============================================================
